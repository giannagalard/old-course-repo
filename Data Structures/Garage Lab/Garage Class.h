...
void GarageClass::AddCar(Cars car)
{
	...
	cout << "Its License Plate is: " << car.plate << endl << endl;
...
void GarageClass::DepartingCar(Cars car)
{
	...
	else if (Lane2.search(car) == true)
	{
		...
		cout << " It has been moved" << temp.moved << "times" << endl << endl;
		Lane2.pop();
		EmptyStreet("Lane2");
	}
	else
		cout << "The car with license plate" << car.plate << " is not here" << endl << endl;
}
